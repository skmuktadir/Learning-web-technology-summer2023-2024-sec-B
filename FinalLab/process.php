...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If score is 60% or higher, save the result to the database
    if ($score_percentage >= 60) {
        ...
        echo "<p><h2>Name:</h2><h3>$name</h3></p>";
        echo "<h1>Please Retake The Quiz</h1>";
        $conn = mysqli_connect('localhost', 'root', '', 'localUsers');
        ...
        // SQL query to insert data
        $sql = "INSERT INTO users2 (Id, userName, score) VALUES ('$id', '$name', '$score')";

        if (mysqli_query($conn, $sql)) {
            echo "Retake Record saved successfully!";
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        }
        // Close connection
